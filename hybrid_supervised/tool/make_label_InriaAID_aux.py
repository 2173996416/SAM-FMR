...
if __name__ == '__main__':
    ...
    save_path = r'J:\_Experiment\weakly_supervised\chicago_aux\sp_256-f'
    label_path = r'J:\_Experiment\weakly_supervised\chicago_aux\label_out_0.2'
    ...
    for tif in tif_list:
        ...
        if np.count_nonzero(a1) == 0:
            v[...] = 0
        label_img = Image.fromarray(v.astype(np.uint8))
